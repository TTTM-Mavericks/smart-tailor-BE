...
VALUES (GenerateCustomKeyString(), 'Happy Sad White',
        'https://res.cloudinary.com/dby2saqmn/image/upload/v1721382631/system-item/zldstwj0wsqw7kmaqxb0.jpg', TRUE,
        'ICON', TRUE, current_timestamp, NULL),
       (GenerateCustomKeyString(), 'Happy Sad Nigga',
        'https://res.cloudinary.com/dby2saqmn/image/upload/v1721382623/system-item/qcls0ellfxwcmr3owkfj.jpg', TRUE,
        'ICON', FALSE, current_timestamp, NULL),
       (GenerateCustomKeyString(), 'Music Chilling',
        'https://res.cloudinary.com/dby2saqmn/image/upload/v1721382631/system-item/iws75egp5pya3wrad22e.jpg', TRUE,
        'IMAGE', TRUE, current_timestamp, NULL),
       (GenerateCustomKeyString(), 'Just Do It',
        'https://res.cloudinary.com/dby2saqmn/image/upload/v1721382631/system-item/ghgndgsazhr1fsw9s02u.jpg', TRUE,
        'IMAGE', TRUE, current_timestamp, NULL),
       (GenerateCustomKeyString(), 'No Pain No Gain',
        'https://res.cloudinary.com/dby2saqmn/image/upload/v1721382622/system-item/fzdonu32wlczedt4rl2r.jpg', TRUE,
        'IMAGE', FALSE, current_timestamp, NULL),
       (GenerateCustomKeyString(), 'Placeit',
        'https://res.cloudinary.com/dby2saqmn/image/upload/v1721382631/system-item/xovhntso2wvzutywphvz.jpg', TRUE,
        'IMAGE', TRUE, current_timestamp, NULL),
       (GenerateCustomKeyString(), 'Sales',
        'https://res.cloudinary.com/dby2saqmn/image/upload/v1721382631/system-item/d5k2glgxnfcfj3hghc6a.jpg', TRUE,
        'ICON', TRUE, current_timestamp, NULL),
       (GenerateCustomKeyString(), 'Shop Sustences',
        'https://res.cloudinary.com/dby2saqmn/image/upload/v1721382624/system-item/qqkmptye2kuageh1dsjr.jpg', TRUE,
        'ICON', TRUE, current_timestamp, NULL),
       (GenerateCustomKeyString(), 'Fashion',
        'https://res.cloudinary.com/dby2saqmn/image/upload/v1721382623/system-item/on7eyszvsanisllwsdlw.jpg', TRUE,
        'ICON', TRUE, current_timestamp, NULL),
       (GenerateCustomKeyString(), 'MR.P',
        'https://res.cloudinary.com/dby2saqmn/image/upload/v1721382623/system-item/g7ztxjyyafjrwbue4vcm.jpg', TRUE,
        'IMAGE', TRUE, current_timestamp, NULL),
       (GenerateCustomKeyString(), 'KarmaShek',
        'https://res.cloudinary.com/dby2saqmn/image/upload/v1721382616/system-item/n2i4r52dkn86fqdgc8hi.jpg', TRUE,
        'IMAGE', FALSE, current_timestamp, NULL),
       (GenerateCustomKeyString(), 'Dog Cute',
        'https://res.cloudinary.com/dby2saqmn/image/upload/v1721382616/system-item/jhmck5g6akn6g45u7zes.jpg', TRUE,
        'ICON', FALSE, current_timestamp, NULL),
       (GenerateCustomKeyString(), 'Orange',
        'https://res.cloudinary.com/dby2saqmn/image/upload/v1721382616/system-item/vpta9r0m0uzmtvhxrmll.jpg', TRUE,
        'IMAGE', TRUE, current_timestamp, NULL),
       (GenerateCustomKeyString(), 'Happy',
        'https://res.cloudinary.com/dby2saqmn/image/upload/v1721382616/system-item/f7m0dsbfzmwwsziudhrp.jpg', TRUE,
        'IMAGE', FALSE, current_timestamp, NULL),
       (GenerateCustomKeyString(), 'Life',
        'https://res.cloudinary.com/dby2saqmn/image/upload/v1721382616/system-item/ie0crj3nifajmvti4mcf.jpg', TRUE,
        'IMAGE', FALSE, current_timestamp, NULL),
       (GenerateCustomKeyString(), 'SuiSailet',
        'https://res.cloudinary.com/dby2saqmn/image/upload/v1721382607/system-item/cxemu0v5yymkgrimsg5p.jpg', TRUE,
        'ICON', TRUE, current_timestamp, NULL),
       (GenerateCustomKeyString(), 'Sautter',
        'https://res.cloudinary.com/dby2saqmn/image/upload/v1721382607/system-item/eu8xmqu8afgkhi8ditvt.jpg', TRUE,
        'ICON', FALSE, current_timestamp, NULL),
       (GenerateCustomKeyString(), 'Bus',
        'https://res.cloudinary.com/dby2saqmn/image/upload/v1721382606/system-item/fewdcw6xcx28qodd4cul.jpg', TRUE,
        'ICON', FALSE, current_timestamp, NULL),
       (GenerateCustomKeyString(), 'Box',
        'https://i.pinimg.com/236x/53/b1/fd/53b1fd253e54a9fed689935f8982359b.jpg', TRUE, 'ICON', FALSE, current_timestamp, NULL),
       (GenerateCustomKeyString(), 'Shopping',
        'https://i.pinimg.com/564x/b6/b3/c2/b6b3c266de4272978816746d5e6a982b.jpg', TRUE, 'ICON', FALSE, current_timestamp, NULL),
       (GenerateCustomKeyString(), 'Shop',
        'https://i.pinimg.com/564x/01/40/78/014078e022373b6eb0f5600fff66cbbb.jpg', TRUE, 'ICON', TRUE, current_timestamp, NULL),
       (GenerateCustomKeyString(), 'Melody',
        'https://i.pinimg.com/564x/3c/31/f2/3c31f2936b29c622bf39d69d47bb77c4.jpg', TRUE, 'ICON', TRUE, current_timestamp, NULL),
       (GenerateCustomKeyString(), 'Candy',
        'https://i.pinimg.com/564x/1e/98/ff/1e98fff5c3c7781ca0f9b883a98f3b0e.jpg', TRUE, 'IMAGE', TRUE, current_timestamp, NULL),
       (GenerateCustomKeyString(), 'Comments',
        'https://i.pinimg.com/564x/0e/a1/d8/0ea1d81f6ee0df19d36e3d319f9031e7.jpg', TRUE, 'IMAGE', TRUE, current_timestamp, NULL),
       (GenerateCustomKeyString(), 'Loive',
        'https://i.pinimg.com/236x/0c/fc/e5/0cfce5e80520edead31058a6a78c282f.jpg', TRUE, 'IMAGE', FALSE, current_timestamp, NULL),
       (GenerateCustomKeyString(), 'Sunday Morning',
        'https://i.pinimg.com/564x/84/de/25/84de25c3653f3813a05c7df509006757.jpg', TRUE, 'IMAGE', TRUE, current_timestamp, NULL),
       (GenerateCustomKeyString(), 'London',
        'https://i.pinimg.com/236x/74/15/6e/74156e2afcb9c557a9c9141f5781b48e.jpg', TRUE, 'IMAGE', TRUE, current_timestamp, NULL),
       (GenerateCustomKeyString(), 'Quote',
        'https://i.pinimg.com/236x/ea/e1/8d/eae18dc4db431d7892cd7cb82a6726db.jpg', TRUE, 'IMAGE', FALSE, current_timestamp, NULL),
       (GenerateCustomKeyString(), 'lLive',
        'https://i.pinimg.com/236x/08/7a/b5/087ab5cf1865a962a942ec9336296729.jpg', TRUE, 'IMAGE', TRUE, current_timestamp, NULL),
       (GenerateCustomKeyString(), 'Cherry',
        'https://i.pinimg.com/564x/b1/ab/10/b1ab10f770bbd6da1caa7a6cc46b14ed.jpg', TRUE, 'ICON', TRUE, current_timestamp, NULL),
       (GenerateCustomKeyString(), 'Bubble',
        'https://i.pinimg.com/564x/a4/dd/02/a4dd02c4b6d16981d2aee6eb9f448c3e.jpg', TRUE, 'ICON', TRUE, current_timestamp, NULL),
       (GenerateCustomKeyString(), 'Duck',
        'https://i.pinimg.com/564x/ac/c3/2c/acc32c5e9614d1e68f796833188d3c49.jpg', TRUE, 'IMAGE', TRUE, current_timestamp, NULL),
       (GenerateCustomKeyString(), 'Ducky',
        'https://i.pinimg.com/564x/f8/91/b5/f891b53d10e93bc6edb25bc73d59dc05.jpg', TRUE, 'IMAGE', FALSE, current_timestamp, NULL),
       (GenerateCustomKeyString(), '8 Balls',
        'https://i.pinimg.com/564x/fa/89/57/fa89579d742e87c08921bbfec1c1f6c1.jpg', TRUE, 'ICON', TRUE, current_timestamp, NULL),
       (GenerateCustomKeyString(), 'Chilly',
        'https://i.pinimg.com/564x/e8/8d/19/e88d19684158e22460292e77c6ceedf5.jpg', TRUE, 'IMAGE', TRUE, current_timestamp, NULL),
       (GenerateCustomKeyString(), 'Coca',
        'https://i.pinimg.com/564x/e2/cd/cc/e2cdcc9a04afafca80637bc699afd66e.jpg', TRUE, 'ICON', FALSE, current_timestamp, NULL),
       (GenerateCustomKeyString(), 'Sweet',
        'https://i.pinimg.com/564x/72/f3/5f/72f35fe198f34cac282fb3868fbfcf61.jpg', TRUE, 'ICON', TRUE, current_timestamp, NULL),
       (GenerateCustomKeyString(), 'Smile',
        'https://i.pinimg.com/564x/72/f3/5f/72f35fe198f34cac282fb3868fbfcf61.jpg', TRUE, 'IMAGE', FALSE, current_timestamp, NULL),
       (GenerateCustomKeyString(), 'Thunder',
        'https://i.pinimg.com/564x/f1/05/d6/f105d671c6ce8940ea34caee0fea5bd2.jpg', TRUE, 'ICON', TRUE, current_timestamp, NULL),
       (GenerateCustomKeyString(), 'T1',
        'https://i.pinimg.com/564x/b2/0a/65/b20a653428d9f1a035e7d0bf69c1fcc4.jpg', TRUE, 'IMAGE', TRUE, current_timestamp, NULL);
