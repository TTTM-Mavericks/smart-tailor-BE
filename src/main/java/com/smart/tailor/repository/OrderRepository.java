...
public interface OrderRepository extends JpaRepository<Order, UUID> {
    ...
    @Query(nativeQuery = true, value = "select o.* from orders o join design_detail d ON d.order_id = o.order_id WHERE d.brand_id = ?1")
    List<Order> findOrderByBrandID(UUID brandID);
    ...
    List<Order> findParentOrderByUserID(UUID userID);
}
