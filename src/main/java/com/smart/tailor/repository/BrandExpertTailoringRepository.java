...
public interface BrandExpertTailoringRepository extends JpaRepository<BrandExpertTailoring, BrandExpertTailoringKey> {
    ...
    List<BrandExpertTailoring> getBrandExpertTailoringByBrandID(UUID brandID);

    BrandExpertTailoring getBrandExpertTailoringByBrandExpertTailoringKey_BrandIDAndBrandExpertTailoringKey_ExpertTailoringID(UUID brandID, UUID expectTailoringID);
    ...
    void createShortBrandExpertTailoring(UUID brandID, UUID expertTailoringID);
}
